...
var Form = function (_React$Component) {
  ...
  function Form() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.displayName = 'Formsy', _this.state = {
      ...
      _this.state.isValid ? _this.props.onValidSubmit(model, _this.resetModel, _this.updateInputsWithError) : _this.props.onInvalidSubmit(model, _this.resetModel, _this.updateInputsWithError);
